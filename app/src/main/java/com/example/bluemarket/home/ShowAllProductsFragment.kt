...
class ShowAllProductsFragment : MyFragment(), ShowAllProductsAdapter.OnProductListItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homeViewModel.allProductsLiveData.observe(viewLifecycleOwner) {
